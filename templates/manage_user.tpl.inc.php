...
<?php
        foreach($this->page_content['user']['rights'] as $right) {
	        ...
	        print("  <td><a href=\"/manage_user?user_id=".$this->page_content['user']['user_id']."&amp;action=delete_right&amp;right_name=".$right['short_name']."&amp;do=yes&amp;token=".urlencode($this->get_csrf_token())."\">Delete</a></td>\n");
    	    print("</tr>\n");
        }
?>
  </tbody>
